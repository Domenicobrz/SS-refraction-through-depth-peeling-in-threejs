        ...
        this.material = new THREE.ShaderMaterial({
            ...
            fragmentShader: `
                ...
                vec3 getRefractedColor(vec3 refractionDir, vec3 hitPoint, float refractionIndex) {
                    ...
                    // extinction color depends on distance traveled
                    vec3 transmColor = vec3(0.0);
                    // const vec3 yellow = vec3(0.005, 0.175, 1.99);
                    // const vec3 red    = vec3(0.1, 0.675, 0.60);
                    // const float m1 = 2.1;
                    // const float m2 = 2.6;
                    // const vec3 teal   = vec3(0.50 * m1, 0.10 * m1, 0.05 * m1);
                    // const vec3 blue   = vec3(0.50 * m2, 0.10 * m2, 0.05 * m2);
                    // if(transmissionDistance < 0.5) {
                    //     float t = transmissionDistance / 0.5;
                    //     transmColor = mix(yellow, red, t);
                    // } else if (transmissionDistance > 0.5 && transmissionDistance < 1.0) {
                    //     float t = (transmissionDistance - 0.5) / 0.5;
                    //     transmColor = mix(red, teal, t);
                    // } else if (transmissionDistance > 1.0 && transmissionDistance < 1.5) {
                    //     float t = (transmissionDistance - 1.0) / 0.5;
                    //     transmColor = mix(red, teal, t);
                    // } else if (transmissionDistance > 1.5 && transmissionDistance < 2.0) {
                    //     float t = (transmissionDistance - 1.5) / 0.5;
                    //     transmColor = mix(teal, blue, t);
                    // } else {
                    //     transmColor = blue;
                    // }
                    ...
                    const vec3 blue   = vec3(0.50, 0.10, 0.05)   * 2.1;
                    if(transmissionDistance < 0.33) {
                        float t = transmissionDistance / 0.33;
                        transmColor = mix(yellow, red, t);
                    } else if (transmissionDistance > 0.33 && transmissionDistance < 1.5) {
                        float t = (transmissionDistance - 0.33) / 1.26;
                        transmColor = mix(red, teal, t);
                    } else if (transmissionDistance > 1.5 && transmissionDistance < 1.75) {
                        float t = (transmissionDistance - 1.5) / 0.25;
                        transmColor = mix(teal, blue, t);
                    } else if (transmissionDistance > 1.75 && transmissionDistance < 2.0) {
                        float t = (transmissionDistance - 1.75) / 0.25;
                        transmColor = mix(blue, blue, t);
                    } else {
                        transmColor = blue;
                    }
                ...
                void main() {
                    ...
                    // displace refracted such that it gets closer to the viewing dir
